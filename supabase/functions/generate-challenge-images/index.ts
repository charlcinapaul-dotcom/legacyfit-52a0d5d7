...
const challengeImagePrompts: Record<string, string> = {
  ...
  "georgia-button-gwinnett": "A dramatic artistic illustration of Button Gwinnett signing the Declaration of Independence in Philadelphia 1776, Georgia's colonial seal visible, other delegates surrounding the document, colonial red and deep navy tones, aged parchment white accents, warm hall light on parchment, the weight of an uncommon name making history symbolism, 16:9 aspect ratio hero banner, ultra high resolution",
};
