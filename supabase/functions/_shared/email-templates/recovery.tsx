...
export const RecoveryEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Reset your LegacyFit password — keep your journey going.</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <div style={divider} />
        <Heading style={h1}>Let's get you back on track.</Heading>
        <Text style={text}>
          We received a request to reset your LegacyFit password. Click below to choose a new one and continue your journey.
        </Text>
        <Text style={text}>This link expires in 24 hours — don't let it slow you down.</Text>
        <div style={btnWrap}>
