...
export const SignupEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Confirm your email — your journey through history starts here.</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          ...
          ! Confirm your email address to activate your account and start your first walking challenge.
        </Text>
        <Text style={text}>Every mile you walk unlocks a piece of history. Let's get moving.</Text>
        <div style={btnWrap}>
        ...
        <Text style={footer}>
          Sent to {recipient}. If you didn't create a LegacyFit account, you can safely ignore this email.
        </Text>
