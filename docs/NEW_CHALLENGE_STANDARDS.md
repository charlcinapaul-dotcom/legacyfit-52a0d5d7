...
| `historical_event`       | **Exactly 3 sentences.** This is the ElevenLabs Charlie P narration text. Sentence 1: introduce the person/event. Sentence 2: describe the significance. Sentence 3: connect to legacy or impact.                          |
