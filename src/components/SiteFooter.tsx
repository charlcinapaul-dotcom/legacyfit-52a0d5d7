    ...
    <div className="container mx-auto">
      <div className="grid md:grid-cols-4 gap-8 mb-8">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">Movement for women who refuse to slow down.</p>
        </div>
        ...
        <div>
          ...
          <div className="flex flex-col gap-2 text-sm text-muted-foreground">
            ...
            <Link to="/why-we-give" className="hover:text-foreground transition-colors">
              Why We Give
            </Link>
      ...
      <div className="mt-6 pt-4 border-t border-border">
        <p className="text-xs text-muted-foreground text-center max-w-2xl mx-auto">
          LegacyFit is an educational platform. All historical figures, events, and references are included solely for
          educational and informational purposes. We are not affiliated with, endorsed by, or associated with any
          individual, organization, or estate referenced.
        </p>
      </div>
    </div>
  </footer>
