  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Transform your daily walks into a journey through history. Every milestone unlocks powerful stories from the trailblazers who changed the world."
        />
      ...
      <PageLayout>
        ...
        <section className="relative min-h-[100vh] flex flex-col justify-start md:justify-center pt-16 pb-20 px-4 overflow-hidden w-full max-w-full bg-background">
          <div className="absolute inset-0 overflow-hidden bg-[#D8C29A]">
            <img
              src={heroImage}
              alt=""
