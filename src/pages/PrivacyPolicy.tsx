      ...
      <div className="container mx-auto max-w-3xl">
        ...
        <div className="mb-8 bg-card rounded-xl border border-border p-6">
          <p className="text-sm text-muted-foreground leading-relaxed">
            ...
            we collect, use, disclose, and safeguard your information when you use the LegacyFit mobile application and
            website (legacyfitvirtual.com).
          </p>
        ...
        <div className="space-y-6">
          ...
          <section className="bg-card rounded-xl border border-border p-6">
            <h2 className="text-lg font-semibold text-foreground mb-4">
              3. Legal Basis for Processing (Apple Requirement)
            </h2>
            <div className="text-sm text-muted-foreground space-y-2">
          ...
          <section className="bg-card rounded-xl border border-border p-6">
            ...
            <div className="text-sm text-muted-foreground space-y-2">
              ...
              <ul className="list-disc list-inside space-y-1 ml-2">
                <li><span className="font-medium text-foreground">Supabase</span> — secure database and authentication</li>
                <li><span className="font-medium text-foreground">Stripe</span> — payment processing</li>
                <li><span className="font-medium text-foreground">ElevenLabs</span> — audio narration</li>
                <li><span className="font-medium text-foreground">Resend</span> — transactional email</li>
              </ul>
              <p className="mt-2">
          ...
          <section className="bg-card rounded-xl border border-border p-6">
            <h2 className="text-lg font-semibold text-foreground mb-4">
              9. Account Deletion (Apple Requirement)
            </h2>
            <div className="text-sm text-muted-foreground space-y-2">
